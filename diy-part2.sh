...
sed -i 's/192.168.1.1/192.168.31.1/g' $OPENWRT_DIR/package/base-files/files/bin/config_generate
...
#sed -i 's/zh_cn/auto/g' $OPENWRT_DIR/feeds/luci/modules/luci-base/root/etc/uci-defaults/luci-base 
...
#cp $WORK_DIR/lean/Redmi-AX6000/data/zones.lua $OPENWRT_DIR/feeds/luci/applications/luci-app-firewall/luasrc/model/cbi/firewall/
